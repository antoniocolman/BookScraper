...
if TYPE_CHECKING:
    from .experimental.yenny_search_experimental import QueryItem, MatchResult  # noqa: F401


def _exp():
    # Lazy import: así "python -m app sites" no explota si experimental tiene deps/errores
    from .experimental import yenny_search_experimental as ye
    return ye
